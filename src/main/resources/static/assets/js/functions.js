...
jQuery(document).ready(function ($) {
    ...
    function getDayDisantce() {
        var countDownDate = new Date("Feb 16, 2019 11:08:00 GMT+8").getTime();
    ...
    function getDay() {
        days = Math.floor(getDayDisantce() / (1000 * 60 * 60 * 24));
        return days
    }

    function getHours() {

        hours = Math.floor((getDayDisantce() % (1000 * 60 * 60 * 24)) / (1000 * 60 * 60));
        return hours
    ...
    function getMin() {
        ...
        minutes = Math.floor((getDayDisantce() % (1000 * 60 * 60)) / (1000 * 60));
        return minutes
    }

    function getSec() {
        seconds = Math.floor((getDayDisantce() % (1000 * 60)) / 1000);
        return seconds
    }
