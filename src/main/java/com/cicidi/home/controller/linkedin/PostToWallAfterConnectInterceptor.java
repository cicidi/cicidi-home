...
//
//@Component
//public class PostToWallAfterConnectInterceptor implements ConnectInterceptor<LinkedIn> {
//
//    public void preConnect(ConnectionFactory<LinkedIn> connectionFactory, MultiValueMap<String, String> parameters, WebRequest request) {
...
//
//    private static final String POST_TO_WALL_ATTRIBUTE = "linkedinConnect." + POST_TO_WALL_PARAMETER;
//}
